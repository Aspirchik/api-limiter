...
return [
    ...
    'logs' => [
        ...
        'cleanup_confirm' => 'Вы уверены, что хотите очистить старые записи логов на основе периода автоочистки?',
        'cleanup_success' => 'Очистка логов завершена: удалено :deleted записей, освобождено :space_freed (период: :period)',
        'datetime' => 'Дата/Время',
        'message' => 'Сообщение',
        'context' => 'Контекст',
        ...
        'auto_cleanup_help' => 'Автоматически удаляет записи логов старше указанного периода. Очистка запускается во время API запросов (20% вероятность) или при ручном запуске.',
        'cleanup_periods' => [
            '15_min' => '15 минут',
            '30_min' => '30 минут', 
            '1_hour' => '1 час',
